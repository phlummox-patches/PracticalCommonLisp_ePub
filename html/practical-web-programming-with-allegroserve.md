...
Although using `FORMAT` to emit HTML works fine for the simple pages
...
If you fill in the form with the "abc" and "def" values, clicking
...
Of these, you need to worry only about `:expires`. It controls how long
